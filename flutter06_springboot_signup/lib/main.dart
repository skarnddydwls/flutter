...
import 'package:flutter06_springboot_signup/screens/signUpPage.dart';
...
/*
    ...
    SafeArea:
      ...
      가려지거나 사라지는 UI가 생기게 됨.
      직접 마진, 패딩을 줘야됨
      but, SafeArea를 사용하면 충분한 패딩을 알아서 줌

    stepper: 단계별 진행 상황을 표시
      - steps: 화면에 보여줄 Step 리스트
      - type: 수직으로 보여줄 것인지, 수평으로 보여줄 것인지
      - elevation: type이 수평으로 설정되어 있을 때만 사용 가능, 상단의 표시되는 스텝들의 높이 지정
      - currentStep: 현재 표시되는 스텝의 index값
